  ...
  (views/letsubs [current-tab [:get :view-id]]
    [react/view common-styles/flex
     ...
     [react/view common-styles/flex
      [drawer-view
       [react/view {:style ""}
        [tabs/swipable-tabs current-tab
         {:bottom-tabs? true
          :tabs-list (map #(update % :content tab-content) tabs-list)
          :tab-style styles/tab
          :tabs-container-style (merge (styles/tabs-container false)
                                       styles/tabs-container-line)
          :main-container-style styles/main-container}]]]]]))
